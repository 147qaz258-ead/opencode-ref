...
export function applyDirectoryEvent(input: {
  ...
  switch (event.type) {
    ...
    case "message.updated": {
      ...
      const parentInfo = info.role === "assistant" ? (info as any).parentID : "N/A"
      console.log(`[EventReducer] message.updated: ${info.id}, role: ${info.role}, parentID: ${parentInfo}`)
    ...
    case "message.part.updated": {
      ...
      console.log(`[EventReducer] message.part.updated: ${part.id}, type: ${part.type}, messageID: ${part.messageID}`)
