      ...
      return {
        ...
        set(model: ModelKey | undefined, options?: { recent?: boolean }) {
          batch(() => {
            ...
            // Use "build" agent instead of current agent for default model selection
            const defaultAgent = "build"
            const buildAgent = agent.list().find((a) => a.name === defaultAgent)
            const targetAgent = buildAgent ?? currentAgent
            if (targetAgent) setEphemeral("model", targetAgent.name, model ?? fallbackModel())
