                    ...
                    <Switch>
                      <Match when={provider().id === "opencode"}>
                        <div class="flex flex-col gap-4">
                          <div class="text-14-regular text-text-base">
                            OpenKore Zen gives you access to a curated set of reliable optimized models for coding
                            agents.
                          </div>
                          <div class="text-14-regular text-text-base">
                    ...
                    return (
                      <div class="flex flex-col gap-6">
                        <div class="text-14-regular text-text-base">
                          ...
                          code to connect your account and use {provider().name} models in OpenKore.
                        </div>
                        <form onSubmit={handleSubmit} class="flex flex-col items-start gap-4">
                          <TextField
                            autofocus
                    ...
                    return (
                      <div class="flex flex-col gap-6">
                        <div class="text-14-regular text-text-base">
                          ...
                          connect your account and use {provider().name} models in OpenKore.
                        </div>
