...
import { createOpencodeClient, jsonBodySerializer } from "@opencode-ai/sdk/v2/client"
...
export function DialogSelectServer() {
  ...
  return (
    <Dialog title="Servers" description="Switch which OpenKore server this app connects to.">
