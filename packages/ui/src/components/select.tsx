...
// Exclude Button's onSelect and value from ButtonProps to avoid conflict with Select's
type SelectButtonProps = Omit<ButtonProps, "onSelect" | "value">

export function Select<T>(props: SelectProps<T> & SelectButtonProps) {
